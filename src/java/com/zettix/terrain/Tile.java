...
public final class Tile {
  ...
  public Tile(final double x,final  double y,final double z, final double rx,
  ...
  double GetHeight(double xi, double yi) {
    ...
    double x0 = (xi - x) * rx_1;   // (xi - x) / rx -> 0...1
    double y0 = (yi - y) * ry_1;   // (yi - y) / ry -> 0...1
